...
#ifndef rtkPolyquantConeBeamReconstructionFilter_h
#define rtkPolyquantConeBeamReconstructionFilter_h
...
class ITK_EXPORT PolyquantConeBeamReconstructionFilter :
  public rtk::IterativeConeBeamReconstructionFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef PolyquantConeBeamReconstructionFilter                                 Self;
...
/** Standard New method. */
  ...
  itkTypeMacro(PolyquantConeBeamReconstructionFilter, IterativeConeBeamReconstructionFilter);
...
protected:
  PolyquantConeBeamReconstructionFilter();
  ~PolyquantConeBeamReconstructionFilter() {}
...
private:
  ...
  PolyquantConeBeamReconstructionFilter(const Self&);
...
#include "rtkPolyquantConeBeamReconstructionFilter.hxx"
#endif
